...
export function HeroSection({ headline, subheadline, ctaLabel, ctaHref, image }: { headline: string, subheadline?: string, ctaLabel: string, ctaHref: string, image: string }) {
  ...
  return (
    <section className="relative w-full overflow-hidden full-screen">
      ...
      {/* Centered content */}
      <div className="relative z-10 flex items-center justify-center px-6 text-center full-screen">
        <motion.div
