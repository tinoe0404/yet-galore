    ...
    <footer className="bg-charcoal text-cream pt-20 pb-8 px-6 lg:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 font-sans">
              ...
              <li className="pt-2">
                <a href="https://wa.me/123456789" target="_blank" rel="noreferrer" className="group flex items-center gap-2 text-cream hover:text-white transition-colors duration-200">
                  <span>Chat with us</span>
                  <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                </a>
              </li>
              <li>
                <a href="mailto:enquiries@yetgalore.com" className="text-cream hover:text-white transition-colors duration-200">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 font-sans text-xs text-cream/50 border-t border-cream/10">
          <p>© {new Date().getFullYear()} Yet Galore. All rights reserved.</p>
