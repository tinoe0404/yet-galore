          ...
          <div className="w-full lg:w-1/3 flex flex-col space-y-12">
            <div>
              ...
              <ul className="space-y-6">
                <li>
                  <a href={`mailto:${siteProfile.email}`} className="group flex items-center gap-3 font-sans text-sm hover:text-black/70 transition-colors">
                      <Mail className="w-4 h-4 text-muted group-hover:text-black/70 transition-colors" />
                      {siteProfile.email}
                    </a>
                </li>
                <li>
                  <a href={siteProfile.whatsapp} target="_blank" rel="noreferrer" className="group flex items-center gap-3 font-sans text-sm hover:text-black/70 transition-colors">
                ...
                <li>
                  <a href="tel:+263788346205" className="group flex items-center gap-3 font-sans text-sm hover:text-black/70 transition-colors">
                    <svg className="w-4 h-4 text-muted group-hover:text-black/70 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    +263 78 834 6205
                  </a>
                </li>
                <li>
                  <a href={siteProfile.instagram} target="_blank" rel="noreferrer" className="group flex items-center gap-3 font-sans text-sm hover:text-black/70 transition-colors">
                    <svg className="w-4 h-4 text-muted group-hover:text-black/70 transition-colors" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                    @yetgalore
                  </a>
                </li>
                <li>
                  <a href={siteProfile.tiktok} target="_blank" rel="noreferrer" className="group flex items-center gap-3 font-sans text-sm hover:text-black/70 transition-colors">
