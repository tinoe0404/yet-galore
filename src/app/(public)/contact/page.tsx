          ...
          <div className="w-full lg:w-1/3 flex flex-col space-y-12">
            <div>
              ...
              <ul className="space-y-6">
                ...
                <li>
                  <a href="https://instagram.com" target="_blank" rel="noreferrer" className="group flex items-center gap-3 font-sans text-sm hover:text-black/70 transition-colors">
                ...
                <li>
                  <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="group flex items-center gap-3 font-sans text-sm hover:text-black/70 transition-colors">
